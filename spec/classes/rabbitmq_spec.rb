...
describe 'rabbitmq' do
  ...
  context 'on Redhat' do
    ...
    it 'includes rabbitmq::repo::rhel' do
      ...
      should contain_exec('rpm --import http://www.rabbitmq.com/rabbitmq-release-signing-key.asc')
    end
...
'
  ...
  context 'on Redhat' do
    ...
    it 'does not import repo public key when repos_ensure is false' do
      should contain_class('rabbitmq::repo::rhel')
      should_not contain_exec('rpm --import http://www.rabbitmq.com/rabbitmq-release-signing-key.asc')
    end
  end
  ...
  ['RedHat', 'SuSE'].each do |distro|
    describe "repo management on #{distro}" do
      describe 'imports the key' do
        ...
        let(:params) {{ :package_gpg_key => 'http://www.rabbitmq.com/rabbitmq-release-signing-key.asc' }}
